...
contract CarbonCredit {
    ...
    function orgName1() external view returns (string){
        return organisationName;
    }

    function distanceCovered1() external view returns (uint32){
        return distanceCovered;
    }

    function transportationMode1() external view returns (string){
        return transportationMode;
    }

    function vehicleWeight1() external view returns (uint32){
        return vehicleWeight;
    }

    function numberOfVehicles1() external view returns (uint32){
        return numberOfVehicles;
    }

    function cargoWeight1() external view returns (uint32){
        return cargoWeight;
    }

    function unitsOfElectricity1() external view returns (uint32){
        return unitsOfElectricity;
    }

    function typeOfEnergy1() external view returns (string){
        return typeOfEnergy;
    }

    function typeOfTravel1() external view returns (string){
        return typeOfTravel;
    }

    function modeOfTransportInComumute1() external view returns (string){
        return modeOfTransportInComumute;
    }

    function totalDistanceTravelled1() external view returns (uint32){
        return totalDistanceTravelled;
    }

    function enterTotalDistanceCovered1() external view returns (uint32){
        return enterTotalDistanceCovered;
    }

    function modeOfTransportInProduct1() external view returns (string){
        return modeOfTransportInProduct;
    }

    function weightOfVehiclesInProduct1() external view returns (uint32){
        return weightOfVehiclesInProduct;
    }

    function weightOfCargoInProduct1() external view returns (uint32){
        return weightOfCargoInProduct;
    }

    function noOfVehiclesInProduct1() external view returns (uint32){
        return noOfVehiclesInProduct;
    }

    function typeOfGasPurchased1() external view returns (string){
        return typeOfGasPurchased;
    }

    function enterQuantityPurchasedInGases1() external view returns (uint32){
        return enterQuantityPurchasedInGases;
    }

    function typeOfPowerUsed1() external view returns (string){
        return typeOfPowerUsed;
    }

    function purchasedQuantityOfCredit1() external view returns (uint32){
        return purchasedQuantityOfCredit;
    }
